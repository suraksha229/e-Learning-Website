...
function education_mind_scripts() {
	...
	wp_enqueue_style( 'education-mind-style', get_stylesheet_uri(), array(), '1.0.2' );
	...
	wp_enqueue_script( 'education-mind-custom', get_template_directory_uri() . '/js/custom' . $min . '.js', array( 'jquery' ), '1.0.0', true );

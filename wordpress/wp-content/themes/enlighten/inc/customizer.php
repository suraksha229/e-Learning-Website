		...
		$wp_customize->add_section(
		    new enlighten_Customize_Section_Pro(
		        ...
		        array(
                    ...
                    'title1'    => esc_html__( 'Free vs Pro', 'enlighten' ),
                    'pro_text' => esc_html__( 'Go Pro','enlighten' ),
		            'pro_text1' => esc_html__( 'Compare','enlighten' ),
                    'pro_url'  => esc_url('https://accesspressthemes.com/wordpress-themes/enlighten-pro/'),
		            'pro_url1'  => admin_url( 'themes.php?page=enlighten-welcome&section=free_vs_pro'),
		            'priority' => 1,
		        )
		    )
		);

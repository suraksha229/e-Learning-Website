...
if ( ! class_exists( 'Education_Mind_Demo' ) ) {
	 ...
	 * @version 1.0.1
	 */
	class Education_Mind_Demo {

		/**
		 * Singleton instance of Education_Mind_Demo.
		 *
		 * @var Education_Mind_Demo $instance Education_Mind_Demo instance.
		 */
		...
		/**
		 * Main Education_Mind_Demo instance.
		 *
		 * @since 1.0.0
		 *
		...
		public static function init( $config ) {
			if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Education_Mind_Demo ) ) {
				self::$instance = new Education_Mind_Demo();
